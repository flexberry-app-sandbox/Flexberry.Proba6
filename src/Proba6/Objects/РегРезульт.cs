...
namespace IIS.Proba6
{
    ...
    public class РегРезульт : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Proba6.ИтогСобес fИтогСобес;
        ...
        private IIS.Proba6.ПланирСобес fПланирСобес;
        
        private IIS.Proba6.Сотрудники fСотрудники;
        ...
        public virtual IIS.Proba6.ИтогСобес ИтогСобес
        {
            get
            {
                ...
                IIS.Proba6.ИтогСобес result = this.fИтогСобес;
        ...
        [PropertyStorage(new string[] {
                "ПланирСобес"})]
        [NotNull()]
        public virtual IIS.Proba6.ПланирСобес ПланирСобес
        {
            get
            {
                ...
                IIS.Proba6.ПланирСобес result = this.fПланирСобес;
        ...
        [PropertyStorage(new string[] {
                "Сотрудники"})]
        [NotNull()]
        public virtual IIS.Proba6.Сотрудники Сотрудники
        {
            get
            {
                ...
                IIS.Proba6.Сотрудники result = this.fСотрудники;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View РегРезультE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РегРезультE", typeof(IIS.Proba6.РегРезульт));
                }
            }
            ...
            public static ICSSoft.STORMNET.View РегРезультL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РегРезультL", typeof(IIS.Proba6.РегРезульт));
                }
            }
        }
    }
